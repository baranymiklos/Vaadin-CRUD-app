...
public class UserView extends VerticalLayout {
    ...
    public void init() {
        ...
        grid.addColumn(UserEntity::getFirstName).setHeader("Firstname").setSortable(true);
        grid.addColumn(UserEntity::getLastName).setHeader("Lastname").setSortable(true);
    ...
    private void addForm(Grid<UserEntity> grid) {
        ...
        firstnameField.add(new Text("Firstname"), firstname);

        HorizontalLayout lastnameField = new HorizontalLayout();
        lastname = new TextField();
        lastnameField.add(new Text("Lastname"), lastname);
        ...
        form.add(firstnameField, lastnameField, nameField, authorField, passwordField, addSaveBtn(grid));
        add(form);
